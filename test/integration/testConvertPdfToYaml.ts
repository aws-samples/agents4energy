    ...
    "Records": [
        {
            ...
            "eventSource": "aws:sqs",
            "eventSourceARN": "arn:aws:sqs:us-east-1:REPLACED:amplify-agentsforenergy-pw-sandbox-8d4645142-PdfToYamlQueue4E2C37F2-MIsiQmYJE4vw",
            "awsRegion": "us-east-1"
        }
    ]
}
